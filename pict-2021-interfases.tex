...
\title{ DESCRIPCIÓN TÉCNICA - PICT 2021 \\ %% HASTA 20 PÁGINAS, 2MB
 {%\Large 
 Título:  \bf Dinámica de fluidos computacional para flujo con interfases móviles en plataformas de HPC}}
...
Los objetivos específicos del proyecto están dados en función de los fenómenos a resolver, brindando para cada uno el marco metodológico previsto.
...
\subsection{Interfases líquido--gas confinadas: flujo en medios porosos en regimen saturado e insaturado}\label{ss:oe21}
...
\subsection{Interfases líquido--líquido confinadas: flujo bifásico inmiscible en generadores de microgotas}
%David, Pablo y Jorge
...
\subsection{Interfases líquido--sólido confinadas: flujo reactivo en reactores microestructurados}
...
\subsection{Interfases líquido--gas no confinadas: superficie libre}
%Gustavo, Laura
Se generarán estrategias para resolver casos con superficie libre empleando el método de volúmenes finitos combinado con metodologías específicas para la representación de interfases en tres dimensiones espaciales, con el propósito de resolver el flujo en cursos de agua con generación y simulación de olas en torno a estructuras total o parcialmente inmersas, así como también la agitación en dominios cerrados. 

\subsection{Interfases líquido--solido: interacción fluido estructura}
%Gustavo, Jorge, Sofía?
BEM para interacción fluido-MEMs?


%Mario, Laura 
Se desarrollarán métodos de resolución de problemas de interacción fluido-estructura, en los cuales los cuerpos inmersos, rígidos, interactúan con un flujo no estacionario, viscoso e incompresible, como ser en sedimentación de partículas o el flujo en torno a cuerpos fijos o con desplazamientos impuestos, en distintas escalas de resolución. 
...
\item{Interfases líquido--gas no confinadas: superficie libre}
%% obras de ingeniería civil, mecánica o naval,
%% %bajo la hipótesis de incompresibilidad del fluido y con  efectos de tensión superficial despreciables, donde se requiere resolver un flujo en superficie libre, por ejemplo, en el escurrimiento en torno a pilas de puentes o fustes de turbinas eólicas~\cite{Suja2018}, o en la agitación o {\it sloshing} que se produce en tanques de transporte o almacenamiento de líquidos \cite{Battaglia2018,Cruchaga2013}, de manera tal que la determinación de los patrones de flujo en estas aplicaciones aporta datos esenciales para la seguridad y el diseño tanto hidrodinámico como estructural; 

\item{Interfases líquido--solido: interacción fluido estructura}
%% en las interacciones entre cuerpos y el medio fluido en que están inmersos~\cite{hou2012} que se presentan en diferentes aplicaciones de interés,% entre las que se cuentan problemas de 
%% %micro-cuerpos (Fig.~\ref{fg-intrincate1}) y sistemas micro-electromec\'anicos (MEMS)~\cite{rf:xiao-ye-2011} (Fig.~\ref{fg-waves40}, izq.), resistencia de olas en cascos de embarcaciones~\cite{rf:aimi-diligenti-2017,rf:jdelia_cam} (Fig.~\ref{fg-waves40}, der.), o de dispositivos total o parcialmente sumergidos denominados  \emph{Wave Energy Converters} (WEC) desarrollados para la generación de energía mareomotriz~\cite{Falnes2007}, Fig~\ref{fg-boyas}. 
%% %
